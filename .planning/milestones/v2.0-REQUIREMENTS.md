# Requirements Archive: v2.0 Synced Playback & Export
...
- [x] **WAVE-05**: Waveform zoom/pan and video playback position stay synchronized
...
- ~~**POL-02**: User can click a tile to expand it fullscreen, click again to return to grid~~ (Dropped — user preference)
